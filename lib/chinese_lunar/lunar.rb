...
module ChineseLunar
  class Lunar
    ...
    @@solar_term = ['小寒', '大寒', '立春', '雨水', '惊蛰', '春分', '清明', '谷雨', 
                    '立夏', '小满', '芒种', '夏至', '小暑', '大暑', '立秋', '处暑', 
                    '白露', '秋分', '寒露', '霜降', '立冬', '小雪', '大雪','冬至']
    @@term_info  = [0,21208,42467,63836,85337,107014,128867,150921,173149,195551,
  ...
  private
    ...
    def get_term(y, n)
      ( 31556925974.7*(y-1890) + @@term_info[n]*60000  ) + Time.utc(1890,1,5,16,2,31).to_i * 1000
    end
